...
public class Material {
    ...
    public static final Material
            ...
            STONE = material("Stone", new Vector2f(2, 4), new Vector2f(2, 4), new Vector2f(2, 4)),
            ...
            BRICKS = material("Bricks", new Vector2f(9, 7), new Vector2f(9, 7), new Vector2f(9, 7)),
            RED_BRICKS = material("Red Bricks", new Vector2f(9, 6), new Vector2f(9, 6), new Vector2f(9, 6));
